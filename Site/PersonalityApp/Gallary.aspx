<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Gallary.aspx.cs" Inherits="CaloriCms.Gallary" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="p-t-0">
                <div class="parallax-head" style="background-image: url('/assets/images/Sands%20Place%20LowReggs-11.jpg');">
            <h1 id="gallaryEn" runat="server">PHOTO GALLERY</h1>
            <h1 style="display:none" id="gallaryAr" runat="server">معرض الصور</h1>
        </div>
    </section>
    ...
    <section id="article__content" class="p-t-0">
        <div class="container gal-container">
            ...
            <%--///////////////////////////////////////////////--%>
             <asp:ListView ID="lstgallaryAr" runat="server">
                <ItemTemplate>
                    <!--8col-->
