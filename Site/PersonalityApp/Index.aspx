                    ...
                    <div class="col-sm-12 ">
                        <div class="main_home_slider">
                            <asp:ListView ID="lstSlider" runat="server">
                             ...
                             <asp:ListView ID="lstSliderAr" runat="server">
                                <ItemTemplate>
                                    <div class="single_home_slider">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                            <h1><%#Eval("ArTitle") %></h1>
                                            <div class="subtitle"><%#Eval("ArDescription") %></div>
                                            <div class="home_btn">
                                                <%--<a href="" class="btn btn-primary slide-btn">MORE</a>--%>
                                            </div>
                                        </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <center>
                        ...
                        <a style="display:none" class="find-out" href="/Founder.aspx" id="foundLinkAr" runat="server">اكتشف!</a>
                    </center>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <h1 style="display:none" class="headline__primary" id="menuheaderAr" runat="server">القائمه</h1>
                    <div class="separator--flower">✻</div>
                    ...
                    <center>
                        ...
                        <a style="display:none" class="find-out" href="/Menu.aspx" id="menuLinkAr" runat="server">وهنا إلى عشاق الطعام في لك!</a>
                    </center>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <center>
                        ...
                        <a style="display:none" class="find-out" href="/Contact.aspx" id="weLinkAr" runat="server">زيارة مطاعمنا!</a>
                     </center>
                </div>
                <div class="col-sm-6 col-md-3">
