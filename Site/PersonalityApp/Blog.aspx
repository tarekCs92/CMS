<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Blog.aspx.cs" Inherits="CaloriCms.Blog" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="p-t-0">
        <div class="parallax-head" style="background-image: url('/assets/images/blog.jpg');">
            <h1 id="blogEn" runat="server">Blog</h1>
            <h1 id="blogAr" runat="server" style="display:none">مدونه</h1>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                     ...
                     <asp:ListView ID="ListView2Ar" runat="server">
                        <ItemTemplate>
                            ...
                            <div class="card mb-4">
                                <img class="card-img-top" style="height: 360px;" src="<%#Eval("Image") %>" alt="Card image cap" width="100%">
                                <div class="card-body">
                                    <h3 class="card-title no-padding"><%#Eval("ArTitle") %></h3>
                                    <p class="card-text"><%#Eval("ArDescription") %></p>
                                    <a href="/blog-details.aspx?id=<%#Eval("Id") %>" class="" style="float:right">قراءة المزيد>></a>
                                </div>
                            </div>
                        </ItemTemplate>
                    </asp:ListView>
                ...
                <div class="col-md-4">
                    ...
                    <!-- Categories Widget -->
                    <div id="menucat" runat="server" class="card my-4">
                        <h5 id="cateEn" runat="server" class="card-header">Categories</h5>
                        <h5 id="cateAr" runat="server" style="display:none" class="card-header">الاقسام</h5>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                    ...
                    <!-- Side Widget -->
                    <div class="card my-4" id="sidewidgetEn" runat="server">
