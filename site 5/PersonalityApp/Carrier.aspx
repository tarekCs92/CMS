        ...
        <div class="container">
            <div class="w3_agile_team_grid">
                <div class="w3_agile_team_grid_left">
                    <h3 class="w3l_header w3_agileits_header">العطلات</h3>
                ...
                <div class="col-md-6 w3ls_banner_bottom_left w3ls_courses_left">
                    <div class="w3ls_courses_left_grids">
                        <div class="w3ls_courses_left_grid">
                            ...
                            <p>
                                مدير مبيعات الطبية
مدير المنتجات في التكنولوجيا الطبية
مدير التسويق في المجال الطبي
موظف مستودع في التكنولوجيا الطبية مع التركيز على مراقبة المخزون
مساعد مبيعات في التكنولوجيا الطبية
