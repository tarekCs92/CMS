    ...
    public partial class Index : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            using (var db = new PersonalityDBEntities())
            {
                ...
                //lstslider.DataBind();
                string myScript = "\n <script src='/js/jquery.min.js'></script><script src='/js/bgfader.js'></script><script type=\"text/javascript\" language=\"Javascript\" id=\"EventScriptBlock\">\n";
                myScript += "var myBgFader = $('.header').bgfader([";
                int xc = 0;
                ...
                myScript += "], { 'timeout': 3000, 'speed': 3000, 'opacity': 0.4 });";
                myScript += "myBgFader.start()";
                myScript += "\n\n </script>";
