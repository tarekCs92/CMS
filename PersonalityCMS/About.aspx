        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-xs-12">
                    ...
                    <h3 runat="server" id="htitle">مهتمنا</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-xs-12">
                            ...
                            <h4>شهادة خبرة</h4>
                            <%--<p class="p-icon">هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن </p>--%>
                        </div>
                        <!--end col-4-->
                        <div class="col-lg-4 col-xs-12">
                    ...
                    <div id="logos">
                        <ul>
                            <asp:ListView ID="lstjobs" runat="server">
                                <ItemTemplate>
                                    <li>
                                        <img class="img-responsive" src="images/clients/758487818090658390657982897073807878788967697967.jpg" />
