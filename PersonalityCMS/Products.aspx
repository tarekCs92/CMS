                ...
                <ItemTemplate>
                        ...
                        <div class="col-md-3 w3_agile_services_grid">
                            ...
                            <div class="agileits_w3layouts_services_grid1">
                                ...
                                <h4><a href="#" onclick="openProduct(this);" data-title="<%#Eval("ArTitle") %>" data-desc="<%#Eval("ArDescription") %>" data-img="<%#Eval("Image") %>"  data-toggle="modal" data-target="#myModal"><%#Eval("ArTitle") %></a></h4>
                            </div>
                        </div>
